...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void _showSettings() {
    showModalBottomSheet(
      ...
      builder: (_) => _SettingsSheet(
          ...
          onSignOut: _handleSignOut), // _SettingsSheet
    );
  }
      ...
      body: CustomScrollView(
        slivers: [
          SliverToBoxAdapter(
            ...
            const Text('ANDROMEDA GALAXY',
                style: TextStyle(
                    color: secondary, fontSize: 12, letterSpacing: 1.2)),
            ...
            const Text('Updated -615 days ago',
                      ...
                      child: Container(
                          ...
                          decoration: BoxDecoration(
                              border: Border(
                                  bottom: BorderSide(
                                      color:
                                          active ? green : Colors.transparent,
                                      width: 2))),
                          child: Text(tabs[i],
                              style: TextStyle(
  ...
  Widget _buildAbout() {
    return Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          const Text('App Inventor',
              style: TextStyle(
                  color: secondary, fontStyle: FontStyle.italic, fontSize: 14)),
          const SizedBox(height: 12),
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                        height: 60,
                        child: CustomPaint(
                            painter: _HcpChartPainter(), size: Size.infinite)),
                  ])),
        ]));
  }
  ...
  Widget _infoCard(IconData icon, String text) {
    return Container(
        ...
        decoration:
            BoxDecoration(color: card, borderRadius: BorderRadius.circular(10)),
        child: Row(children: [
    ...
    return Padding(
        ...
        child: Container(
            ...
            child:
                  ...
                  child: const Row(children: [
                    Expanded(
                        child: Column(
                          ...
                          SizedBox(height: 4),
                          Text(
                              '2025 · interclub · The Explorationists Golf Club',
              ...
              const SizedBox(height: 8),
              _eventRow('EGT 2025 #12 – Desember (Sen...)',
                  '2025-12-13 · Sentul Highland Golf Club', 8, 47, 41, 88, 82),
              const SizedBox(height: 8),
              _eventRow('EGT 2025 #11 – November (BSD...)',
                  '2025-11-15 · The Green BSD City', 8, null, null, null, null),
            ])));
  }

  Widget _eventRow(String name, String sub, int hcp, int? out, int? inn,
      int? gross, int? nett) {
    return Container(
        padding: const EdgeInsets.all(12),
        decoration: BoxDecoration(
    ...
    return Padding(
        ...
        child: Column(children: [
          ...
          const Icon(Icons.camera_alt_outlined,
              color: Color(0xFF2A4A2A), size: 48),
          const SizedBox(height: 16),
          const Text('No photos yet',
              style: TextStyle(
                  ...
                  fontWeight: FontWeight.w600)),
          const SizedBox(height: 8),
          const Text('Tap tombol di atas untuk tambah foto pertama.',
              textAlign: TextAlign.center,
...
class _SettingsSheet extends StatefulWidget {
  ...
  const _SettingsSheet({required this.onAdmin, required this.onSignOut});
}
...
class _SettingsSheetState extends State<_SettingsSheet> {
            ...
            child: Column(
                ...
                children: [
                  ...
                  const Padding(
                      ...
                      child: Divider(color: Color(0xFF2A3A2A))),
                  _item(Icons.admin_panel_settings_outlined, Colors.red,
                      'Admin Dashboard', 'Platform administration',
                      textColor: Colors.red, onTap: widget.onAdmin),
                  const SizedBox(height: 16),
                  _item(
                    Icons.logout,
                    Colors.deepOrange,
  ...
  Widget _item(IconData icon, Color iconColor, String title, String sub,
  ...
  Widget _itemToggle(IconData icon, Color iconColor, String title, String sub,
...
class _AdminDashboardPageState extends State<AdminDashboardPage> {
        ...
        Padding(
            ...
            child: Column(children: [
              Row(children: [
                ...
                const SizedBox(width: 8),
                _statCard(
                    '148', 'Klub', Icons.business_outlined, Colors.orange),
                const SizedBox(width: 8),
                _statCard('4', 'Tur', Icons.emoji_events_outlined, green),
              ]),
              const SizedBox(height: 8),
              Row(children: [
                _statCard('32', 'Event', Icons.calendar_month_outlined,
                    Colors.orange),
                const SizedBox(width: 8),
  ...
  Widget _buildTours() {
    final tours = [
      {
        'name': 'EGT – Explorationis...',
        'sub': 'The Explorationists Golf Club · 12 events · 2025',
        'status': 'completed'
      },
      {
        'name': 'XMAX TOURNAMENT...',
        'sub': 'XMAX-DEPOK · 1 events · 2026',
        'status': 'upcoming'
      },
      {
        'name': 'PPDMring Tour 2026',
        'sub': 'Ppdm Ring Golf · 9 events · 2026',
        'status': 'upcoming'
      },
      {
        'name': 'Paradjana Champio...',
        'sub': 'Paradjana · 10 events · 2026',
        'status': 'upcoming'
      },
    ];
    return ListView(
  ...
  Widget _buildEvents() {
    final events = [
      {
        'name': 'Paradjana Dec 2026',
        'sub': 'Riverside Golf Club · 2026-12-19 · 0 peserta'
      },
      {
        'name': 'Nov 2026',
        'sub': 'Merapi View Golf Course · 2026-11-23 · 0 peserta'
      },
      {
        'name': 'Paradjana Nov 2026',
        'sub': 'Palm Hill Golf Club · 2026-11-21 · 0 peserta'
      },
      {
        'name': 'Oct 2026',
        'sub': 'Matoa Golf & Garden · 2026-10-26 · 0 peserta'
      },
    ];
      ...
      ...events.map((e) => Container(
          ...
          child: Row(children: [
            ...
            Container(
                ...
                decoration: BoxDecoration(
                    border: Border.all(color: const Color(0xFF4A6A4A)),
                    borderRadius: BorderRadius.circular(12)),
    ...
    final courses = [
      {
        ...
        'sub': 'Jatinangor, Sumedang, Jawa Barat · Par 72'
      },
      {
        'name': 'Bukit Pelangi Golf Course',
        'sub': 'Sentul, Bogor, Jawa Barat · Par 72'
      },
      {
        'name': 'Emeralda Golf Club',
        'sub': 'Cimanggis, Depok, Jawa Barat · Par 72'
      },
    ];
    return ListView(padding: const EdgeInsets.all(16), children: [
      Container(
      ...
      ...courses.map((c) => Container(
          ...
          child: Row(children: [
            ...
            TextButton(
                onPressed: () {},
                child: const Text('View', style: TextStyle(color: secondary))),
            const SizedBox(width: 4),
            ElevatedButton(
                onPressed: () {},
      ...
      Container(
          ...
          child: Column(children: [
            const Row(children: [
              ...
              SizedBox(width: 8),
              Text('Ringkasan Platform',
                  style: TextStyle(
                      color: Colors.white, fontWeight: FontWeight.w600)),
            ]),
            const SizedBox(height: 12),
            Row(children: [
              _summaryItem('Total Users', '2840'),
              _summaryItem('Total Clubs', '148')
            ]),
            const SizedBox(height: 8),
            Row(children: [
              _summaryItem('Total Event', '32'),
              _summaryItem('Total Venue', '18')
            ]),
          ])),
    ]);
  }
          ...
          child: const Column(
              ...
              children: [
                Row(children: [
                  ...
                  Text('Platform saat ini dalam mode ',
                ...
                SizedBox(height: 8),
                Text(
                    'Aktifkan fitur satu per satu setelah caddy dan venue siap bergabung.',
                    style: TextStyle(color: secondary, fontSize: 12)),
              ])),
      const SizedBox(height: 12),
      Container(
          ...
          child: Row(children: [
            const Expanded(
                child: Column(
                  ...
                  SizedBox(height: 4),
                  Text('Dropdown pilih caddy saat buat round',
                      style: TextStyle(color: secondary, fontSize: 12)),
                ])),
    ...
    return Column(children: [
      Padding(
          ...
          child: Column(children: [
            ...
            const SizedBox(height: 12),
            Row(
                children: ['A–Z', 'Terbaru', 'Terlama', 'HCP']
                    .map((s) => Container(
                        margin: const EdgeInsets.only(right: 8),
                        padding: const EdgeInsets.symmetric(
                        ...
                        child: Text(s,
                            style: TextStyle(
                                color: s == 'A–Z' ? Colors.white : secondary,
                                fontSize: 13))))
                    .toList()),
            const SizedBox(height: 12),
            ...[
              ...
              ['U', 'V', 'W', 'X', 'Y', 'Z']
                ...
                child: Row(
                    ...
                    children:
                        row.map((l) => _alphaBtn(l, l == 'A')).toList()))),
            const SizedBox(height: 8),
            const Align(
                alignment: Alignment.centerLeft,
                child: Text('271 user berawalan "A"',
                    style: TextStyle(color: secondary, fontSize: 12))),
          ])),
      Expanded(
